...
2. Preparing the target state on $|1\rangle$, we have $|\psi \rangle = \frac{1}{\sqrt{2}} (|0\rangle |0\rangle^n + |1\rangle |\psi_0\rangle)$ 
3. Apply time-evolution operator: $|\psi \rangle =  \frac{1}{\sqrt{2}} (U_{k-j} |0\rangle |0\rangle^n +U_{k-j}   |1\rangle |\psi_0\rangle) =  \frac{1}{\sqrt{2}} (e^{i\phi}|0\rangle |0\rangle^n +U_{k-j}   |1\rangle |\psi_0\rangle) $
