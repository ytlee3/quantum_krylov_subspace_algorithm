...
$P_+ = \frac{1}{4} (\langle \psi_0 | e^{-i \phi} + \langle \psi_0 | U^\dagger_{k-j}) H (e^{i\phi} |\psi_0\rangle + U_{k-j} |\psi_0\rangle) = \frac{1}{4} (\langle H \rangle + \langle H U_{k-j} \rangle + \langle U_{k-j}^\dagger H \rangle + \langle U_{k-j}^\dagger H U_{k-j} \rangle) $
 
$P_0 = \frac{1}{4} (\langle \psi_0 | e^{-i \phi} - \langle \psi_0 | U^\dagger_{k-j}) H (e^{i\phi} |\psi_0\rangle - U_{k-j} |\psi_0\rangle) = \frac{1}{4} (\langle H \rangle - \langle H U_{k-j} \rangle 0 \langle U_{k-j}^\dagger H \rangle + \langle U_{k-j}^\dagger H U_{k-j} \rangle) $
