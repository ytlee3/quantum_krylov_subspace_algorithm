...
## Quantum version 
We aim to solve the ground state energy of a given Hamiltonian $\langle \psi |H|\psi \rangle$, where we can build the wavefunction as $|\psi\rangle = Span [ H^j|\psi_0\rangle ], j = 0,1,2,... D-1 $ (Krylov subspace)
