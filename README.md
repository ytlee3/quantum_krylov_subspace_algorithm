...
$P_{+i}-P_{-i} = \frac{1}{2} ( -i e^{-i \phi} \langle H U_{k-j} \rangle + i e^{i \phi} \langle U^\dagger_{k-j} H \rangle) =\frac{1}{2} ( -i e^{-i \phi} \langle H U_{k-j} \rangle + i (e^{-i \phi} \langle H U_{k-j} \rangle)^\dagger) $ 
